        ...
        <footer className="text-gray-500 dark:text-gray-300 flex flex-wrap gap-1 justify-between w-full px-2 mt-3 text-sm opacity-80">
            {source && source.length > 0 && (
                <p className="flex items-center gap-1 text-sm">
                    ...
                    <a href={source[0]}
                       ...
                       className="font-medium hover:text-gray-900 dark:hover:text-white ocean:text-blue-900 ocean:hover:text-black forest:text-green-900 forest:hover:text-black transition-colors"
                    >
            ...
            <p className="flex items-center gap-1 text-sm">
                ...
                <a href="https://github.com/aniqatc"
                   target="_blank"
                   rel="noopener noreferrer"
                   className="ml-0.5 font-medium hover:text-gray-900 dark:hover:text-white ocean:text-blue-900 ocean:hover:text-black forest:text-green-900 forest:hover:text-black transition-colors"
                >
                    Aniqa
                </a>
            </p>
